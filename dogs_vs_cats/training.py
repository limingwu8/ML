...
def run_training():
    ...
    train_images, train_labels, val_images, val_labels = input_data.get_files(train_dir,ratio)
    
    train_batch, train_label_batch = input_data.get_batch(train_images,
                                                          train_labels,
                                                          IMG_W,
                                                          IMG_H,
                                                          BATCH_SIZE,
                                                          CAPACITY)
    # val_batch, val_label_batch = input_data.get_batch(val_images,
    #                                                   val_labels,
    #                                                   IMG_W,
    #                                                   IMG_H,
    #                                                   BATCH_SIZE,
